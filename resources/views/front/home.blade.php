                ...
                @if (getCategories()->isNotEmpty())
                    @foreach (getCategories() as $category)
                        <div class="col-lg-3">
                            <div class="cat-card">
                                <div class="left">
                                    <img src="{{ asset('front-assets/images/' . $category->name . '.jpg') }}" alt=""
                            ...
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    <a href="{{route("front.product", $product->slug)}}" class="product-img">
                                        ...
                                        <img src="{{ asset('front-assets/images/' . $product->title . '.jpg') }}"
                                            alt="" class="img-fluid"
                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    <a href="{{route("front.product", $product->slug)}}" class="product-img">
                                        {{-- <img class="card-img-top" src="{{ asset('front-assets/images/product-1.jpg') }}" alt=""></a> --}}
                                        <img src="{{ asset('front-assets/images/' . $latestProduct->title . '.jpg') }}"
                                            alt="" class="img-fluid"
                                            style="width: 300px; height: 200px; object-fit: cover;">
                                        <a class="whishlist" href="222"><i class="far fa-heart"></i></a>
