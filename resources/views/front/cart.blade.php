                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('front-assets/images/' . $item->name . '.jpg') }}"
                                                        width="" height="">
                                                    <h2>{{ $item->name }}</h2>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-sm  border-0 text-center"value="{{ $item->qty }}">
                                                    <div class="input-group-btn">
...
>>>>>>> 40ede19e6057b83d192c34538f60ecf6d79102cb
            $.ajax({
